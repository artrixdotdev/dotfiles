...
$env.config = {
    ...
    color_config: $env.theme # if you want a more interesting theme, you can replace the empty record with `$dark_theme`, `$light_theme` or another custom record
    # use_grid_icons: true
    ...
    keybindings: [
        ...
        {
            name: move_down_with_down_arrow
            modifier: none
            keycode: down
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_left_with_left_arrow
            modifier: none
            keycode: left
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_right_or_take_history_hint_with_right_arrow
            modifier: none
            keycode: right
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_one_word_left_with_control_left
            modifier: control
            keycode: left
            mode: [emacs, vi_normal, vi_insert]
        ...
        {
            name: move_one_word_right_or_take_history_hint_with_control_right
            modifier: control
            keycode: right
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_start_with_home
            modifier: none
            keycode: home
            mode: [emacs, vi_normal, vi_insert]
        ...
        {
            name: move_to_line_start_with_control_a
            modifier: control
            keycode: char_a
            mode: [emacs, vi_normal, vi_insert]
            event: { edit: movetolinestart }
        ...
        {
            name: move_to_line_end_or_take_history_hint_with_end
            modifier: none
            keycode: end
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_end_or_take_history_hint_with_control_e
            modifier: control
            keycode: char_e
            mode: [emacs, vi_normal, vi_insert]
            event: {
        ...
        {
            name: move_to_line_start_with_control_home
            modifier: control
            keycode: home
            mode: [emacs, vi_normal, vi_insert]
            event: { edit: movetolinestart }
        ...
        {
            name: delete_one_character_backward_with_backspace
            modifier: none
            keycode: backspace
        ...
        {
            name: delete_one_word_backward_with_control_backspace
            modifier: control
            keycode: backspace
            mode: [emacs, vi_insert]
            event: { edit: backspaceword }
        ...
        {
            name: delete_one_character_forward_with_delete
            modifier: none
            keycode: delete
            mode: [emacs, vi_insert]
            event: { edit: delete }
        ...
        {
            name: delete_one_character_forward_with_control_delete
            modifier: control
            keycode: delete
            mode: [emacs, vi_insert]
            event: { edit: delete }
        ...
        {
            name: delete_one_character_backward_with_control_h
            modifier: control
            keycode: char_h
            mode: [emacs, vi_insert]
            event: { edit: backspace }
        ...
        {
            name: delete_one_word_backward_with_control_w
            modifier: control
            keycode: char_w
            mode: [emacs, vi_insert]
            event: { edit: backspaceword }
        ...
        {
            name: move_right_or_take_history_hint_with_control_f
            modifier: control
            keycode: char_f
            mode: emacs
            event: {
        ...
        {
            name: move_one_word_left_with_alt_left
            modifier: alt
            keycode: left
            mode: emacs
            event: { edit: movewordleft }
        ...
        {
            name: move_one_word_right_or_take_history_hint_with_alt_right
            modifier: alt
            keycode: right
            mode: emacs
            event: {
        ...
        {
            name: move_one_word_left_with_alt_b
            modifier: alt
            keycode: char_b
            mode: emacs
            event: { edit: movewordleft }
        ...
        {
            name: move_one_word_right_or_take_history_hint_with_alt_f
            modifier: alt
            keycode: char_f
            mode: emacs
            event: {
        ...
        {
            name: delete_one_word_backward_with_alt_backspace
            modifier: alt
            keycode: backspace
            mode: emacs
            event: { edit: backspaceword }
        ...
        {
            name: delete_one_word_backward_with_alt_m
            modifier: alt
            keycode: char_m
            mode: emacs
            event: { edit: backspaceword }
